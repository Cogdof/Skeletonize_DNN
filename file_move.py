...
befor_dir = '/home/mll/v_mll3/OCR_data/dataset/MNIST_dataset/EMNIST_byclass/Train'
after_dir = '/home/mll/v_mll3/OCR_data/dataset/MNIST_dataset/EMNIST_byclass/Valid'
...
for label_folder in befor_file_list:
    ...
    test_image_num = len(image_list) * 0.1      # each label images's 10%
